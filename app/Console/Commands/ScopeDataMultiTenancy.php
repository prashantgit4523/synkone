...
class ScopeDataMultiTenancy extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'data-scope:sync-multi';
     ...
     * @var string
     */
    protected $description = 'This command is responsible of setting the scope for previously existing data for multitenancy';
