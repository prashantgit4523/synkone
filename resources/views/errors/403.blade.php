...
.maincontainer {
  ...
  top: -50px;
  transform: scale(0.8);
  background: url("{{asset('assets/images/error/HauntedHouseBackground.png')}}");
...
<div class="maincontainer">
  ...
  <div class="bat">
    <img class="wing leftwing"
         src="{{asset('assets/images/error/bat-wing.png')}}">
    <img class="body"
         src="{{asset('assets/images/error/bat-body.png')}}" alt="bat">
  ...
  <img class="foregroundimg" src="{{asset('assets/images/error/HauntedHouseForeground.png')}}" alt="haunted house">

</div>
<h1 class="errorcode">403 | Forbidden</h1>
<div class="errortext">You are not authorized to access this page. <a href="javascript:void(0);" id="goback">Go Back</a></div>
  <!-- common-scritps  includes
            * jQuery JavaScript 3.5.0
            * slimscroll 3.1.8
            *bootstrap bundle with popper 4.5.3
            * wave.min.js 0.7.6
        -->
