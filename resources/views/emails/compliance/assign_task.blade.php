    ...
    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 16px; margin: 0;">
        ...
        >
            ...
            <p style="color: #000000 !important;margin-bottom:20px;">
                <strong style="color: #000000 !important;">Project Name: </strong> {{ decodeHTMLEntity($data['project']->name) }}
                <br>
                <strong style="color: #000000 !important;">Standard: </strong>{{decodeHTMLEntity($data['project']->standard)}}
            </p>
            @foreach($data['projectControls'] as $key=>  $projectControl)
                ...
                <br>
                <strong style="color: #000000;">Deadline: </strong> {{ date('j M Y', strtotime($projectControl->deadline)) }}
                <br>
                <hr>
            @endforeach
        </td>
