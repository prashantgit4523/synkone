@component('mail::layout')
    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 16px; margin: 0;">
        <td class="content-block"
            ...
            <p>
            You have a pending questionnaire to reply to, for the <strong>{{ $project->name }}</strong> third party risks project which is due on {{ \Carbon\Carbon::parse($project->due_date)->format('d-m-Y h:m A') }}.<br><br>
                Please visit the link below and complete the questionnaire:
            </p>
        </td>
    </tr>
    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 16px; margin: 0;">
        <td class="content-block"
            ...
            <a class="btn btn-primary"
               ...
               href="{{ route('third-party-risk.take-questionnaire', $email_token->token) }}">
                Questionnaire
            </a>
        </td>
    </tr>
