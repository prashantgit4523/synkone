    ...
    const addUserColumns = [
        {
            ...
            CustomComponent: ({ row }) => {
                return (
                    <Fragment>
                        <div className="checkbox checkbox-success" style={{margin: '-25px 0 0 15px'}}>
                            <input
        ...
        <div>
            ...
            >
                ...
                <Modal.Body className="p-3">
                    <div className="modal-body table-container" style={{overflow: 'hidden'}}>
                        <DataTable
                            columns={addUserColumns}
                            fetchUrl={fetchURL}
                            tag="users-and-groups-add-existing-user-modal"
                            search
                            resetOnExit
